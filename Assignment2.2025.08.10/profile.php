        ...
        <div id="main-profile">
            ...
            <?php if ($currentUser): ?>
                ...
                <!-- process: on upload, the file is saved to a temp location (a directory/folder) in the server's cache, so we can inspect/validate before adding it to database
                 ...
                 before uploading, we want to check file extension,size, etc.
                 ...
                 -->
                <form method="post" action="user.php" enctype="multipart/form-data" input type="file"> ? double check this syntax
