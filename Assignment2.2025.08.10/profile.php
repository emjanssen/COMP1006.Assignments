        ...
        <div id="main-profile">
            ...
            <?php if ($currentUser): ?>
                ...
                <!-- process: on upload, the file is saved to a temp location (a directory/folder) in the server's cache, so we can inspect/validate before adding it to database
                 process for uploading files: we do not immediately add the media file to the database; instead, in the database we save the path to the temp file
                 ...
                 in-future, will add photo data validation, potential error messages, and also proper naming convention, i.e. unique session id
                 -->
                ...
                <form method="POST" action="photo.php" enctype="multipart/form-data">
                    <div>
                        ...
                        <!-- no actual restriction login in place yet; code fails silently right now if file is too large -->
                    </div>
                    <div>
